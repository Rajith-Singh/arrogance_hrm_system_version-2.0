...
class PdfService
{
    public function generateAttendanceReport($employee, $attendanceRecords)
    {
        ...
        $pdf->Cell(0, 7, 'Attendance Report', 0, 1, 'C');
        ...
        // Output the PDF
        $pdf->Output("{$employee->emp_no}_{$employee->name}_attendance_report.pdf", 'I');
    }
}
