<div class="p-6 lg:p-8 bg-white border-b border-gray-200">
    ...
    <h2 class="text-2xl font-medium text-gray-900 mt-8">Supervisor in Chief Approval</h2>
    <hr>

    <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6 mt-6">
        <form method="POST" action="/update-supervisor-approval-sic">
            @csrf
            ...
            <div class="mt-4">
                ...
                <textarea id="note" name="supervisor_in_chief_note" rows="4" cols="50" class="form-textarea mt-1 block w-full"></textarea>
            </div>
