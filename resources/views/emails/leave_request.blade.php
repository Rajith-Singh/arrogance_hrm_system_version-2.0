...
<body>
    <div class="email-container">
        <div class="email-header">
            New Leave Request from {{ $leave->user->name }}
        </div>
        <div class="email-body">
            <h2>Hello {{ $supervisorName }},</h2>
            <p>A new leave request has been submitted by {{ $leave->user->name }}. Here are the details:</p>
            ...
            <ul>
                ...
                <li><strong>Covering Person:</strong> {{ $coveringPersonName }}</li>
            </ul>

            <p>Please visit the Arrogance HRM System to review and approve the leave request.</p>

            <p>Thank you,</p>
            <p><strong>HRM System - Arrogance Technologies (Pvt) Ltd</strong></p>
        </div>
